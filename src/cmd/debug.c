...
static char cmd_debug_args_doc[] = "<read ADDRESS|write ADDRESS LENGTH> via INTERFACE [IP PORT USERNAME PASSWORD]";
...
static const struct cmd debug_cmd = {
    "debug",
    "Read or write 4 bytes of data via the AHB bridge",
    do_debug
};
